...
public class ZA_TODOLIST {
    /*
     * TODO :
     *  - GAWIN FUNCTIONAL YUNG MGA BUTTON SA HOME
     *  - LAGYAN NG BOTTOM NAVIGATION YUNG IBANG SHIT BUKOD DUN SA HOME BUTTON OR SIDE PANEL VIEW
     *  - mag lagay ng theme para sa app and some sound and shits
     *  - ayusin yung function ng loading : pag nakalagay na ng question dun sa table mag rereload na lang sya, basta
     *  - LAGYAN NG DESIGN!!!
